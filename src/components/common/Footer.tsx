...
const socialLinksData: SocialLinkItem[] = [
    { id: 'fb', href: 'https://www.facebook.com/61571812801984', label: 'Facebook', icon: FaFacebookF },
    { id: 'tw', href: '#', label: 'Twitter', icon: FaTwitter },
    { id: 'li', href: 'https://linkedin.com/company/viks-production-ai/', label: 'LinkedIn', icon: FaLinkedinIn },
    { id: 'in', href: 'https://www.instagram.com/viks.production/', label: 'Instagram', icon: FaInstagram },
];
